...
def plot_bounding_box(image, annotation_list, class_id_to_name_mapping):
    ...
    print("Shape of annotations array:", annotations.shape)
    print("Annotations array:", annotation_list)
...
def main():
    ...
    parser.add_argument('--image', default='data/flickr_logos_27_dataset/flickr_logos_27_dataset_images/2962045.txt', type=str, help='path to plot image')
    ...
    if opt.plot:
        annotation_file = "data/flickr_logos_27_dataset/flickr_logos_27_dataset_images/2962045.txt"
